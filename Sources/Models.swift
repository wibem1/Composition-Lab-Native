...
enum ComposerPrompts {
    ...
    static func conceptPrompt(_ assignment: String) -> String {
        ...
        Schreibe einen vollständigen, konkret ausnotierbaren musikalischen Entwurf, aus dem anschließend eine andere technische Instanz die MIDI-Daten erzeugen kann. Gib der Komposition einen Namen. Mache keine Erläuterung über deine Arbeitsweise.
        """
    }
