...
# Verhindert, dass macOS beim anschließenden Öffnen nur eine noch laufende
# ältere Fassung mit demselben Bundle-Identifier nach vorn holt.
...
# App-Icon aus der mitgelieferten 1024x1024-PNG-Datei erzeugen.
...
# Intel ist Pflicht. Apple Silicon wird zusätzlich gebaut, wenn das SDK es unterstützt.
build_arch x86_64
