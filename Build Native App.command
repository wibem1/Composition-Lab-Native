...
SRC=(Sources/*.swift)
echo "Baue Composition Lab Native 3.5.3 · Build 3503 · Engine 2.3.1 + isolierte Motivfunktion …"
echo
...
echo
echo "FERTIG: $PWD/$APP"
echo "Version: 3.5.3 (Build 3503) · Composition Engine 2.3.1 · Engine Build 231 · Clean Source + Motivfunktion"
