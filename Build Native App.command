...
if start < 0 or end < 0:
    raise SystemExit('V6.6.2 build preparation: V6.3 label-check block not found')
...
SRC=(Sources/*.swift)
echo "Baue Composition Lab Native V6.6.2 …"
echo
...
echo
echo "FERTIG: $PWD/$APP"
echo "Version: 6.6.2 (Build 106) · Engine Build 14"
echo "V6.6.2: two-row bottom bar · left-aligned Import/Motiv/Compose · project save/load in Datei · slot delete"
open "$APP" || true
