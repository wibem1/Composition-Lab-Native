...
if start < 0 or end < 0:
    raise SystemExit('V6.6.7 build preparation: V6.3 label-check block not found')
...
SRC=(Sources/*.swift)
echo "Baue Composition Lab Native V6.6.7 …"
echo
...
echo
echo "FERTIG: $PWD/$APP"
echo "Version: 6.6.7 (Build 111) · Engine Build 14"
echo "REGULÄRE VERSION: DAW-Brücke läuft im Hintergrund, Diagnose-Menü entfernt."
open "$APP" || true
