...
if start < 0 or end < 0:
    raise SystemExit('V6.5.3 build preparation: V6.3 label-check block not found')
...
SRC=(Sources/*.swift)
echo "Baue Composition Lab Native V6.5.3 …"
echo
...
echo
echo "FERTIG: $PWD/$APP"
echo "Version: 6.5.3 (Build 104) · Engine Build 14"
echo "V6.5.3: much taller and narrower piece cards"
open "$APP" || true
