...
if start < 0 or end < 0:
    raise SystemExit('V6.6.0 build preparation: V6.3 label-check block not found')
...
SRC=(Sources/*.swift)
echo "Baue Composition Lab Native V6.6.0 …"
echo
...
echo
echo "FERTIG: $PWD/$APP"
echo "Version: 6.6.0 (Build 105) · Engine Build 14"
echo "V6.6.0: true custom-drawn piece cards · moderate height · right-click MIDI/CLAB · resizable layout"
open "$APP" || true
